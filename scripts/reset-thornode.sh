...
warn "!!! Destructive command, only apply in case of consensus failure on thor-daemon !!!"
warn "Be careful, your thor-daemon data will be deleted, the service will restart and sync again"
confirm
