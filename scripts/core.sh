...
get_node_service() {
  ...
  menu thornode thornode bifrost midgard gateway binance-daemon dogecoin-daemon ethereum-daemon bitcoin-daemon litecoin-daemon bitcoin-cash-daemon midgard-timescaledb
