...
if [ "$SERVICE" == "" ]; then
  ...
  menu thornode thornode bifrost midgard binance-daemon bitcoin-daemon bitcoin-cash-daemon dogecoin-daemon ethereum-daemon litecoin-daemon terra-daemon gaia-daemon
