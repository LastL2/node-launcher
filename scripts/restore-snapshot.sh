...
get_node_info_short
if [ "$SERVICE" == "" ]; then
  echo "=> Select a LastNode service to restore a snapshot"
...
echo "=> Restoring service $boldyellow$SERVICE$reset of a LastNode named $boldyellow$NAME$reset from snapshot"
echo
