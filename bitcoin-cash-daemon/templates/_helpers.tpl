...
*/}}
{{- define "bitcoin-cash-daemon.name" -}}
...
*/}}
{{- define "bitcoin-cash-daemon.fullname" -}}
...
*/}}
{{- define "bitcoin-cash-daemon.chart" -}}
...
Selector labels
*/}}
{{- define "bitcoin-cash-daemon.selectorLabels" -}}
app.kubernetes.io/name: {{ include "bitcoin-cash-daemon.name" . }}
